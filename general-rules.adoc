...
Generative AI tools and technologies used to create content in a team's code and documentation (including but not limited to text, figures, images) must be disclosed. The AI system used must be identified and be accompanied by a brief explanation regarding the manner in which the AI system was used to generate the content. The use of AI systems for editing and grammar enhancement or translation to English is common practice and does not need to be specified.
Information or content contained in or about a team's code and documentation shall not be processed through an AI system without first gaining approval from the team.

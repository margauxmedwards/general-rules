...
[.text-center]
*License:* This document is licensed under the https://creativecommons.org/licenses/by-nc-sa/4.0/[Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0)] license.
RoboCupJunior Regional committees are free to share and adapt this material for non-commercial, educational purposes, provided appropriate credit is given to RoboCupJunior and any derivative works are distributed under the same license.
Exceptions may be granted by RoboCupJunior on a case-by-case basis. +
...
[[team-continuity]]*Team Continuity*: A team that qualifies for a higher level of
competition (from a regional to a SuperRegional or International
competition) must include at least 2 members of the qualifying team when competing
at the next level. New members may be added, within the maximum team
size, but the qualifying team may not be replaced. All members,
including continuing and new members, must meet the
<<technical-roles,Technical Roles>> requirement.
...
[[technical-roles]]*Technical Roles*: Every team member must have a defined technical
role (mechanical/design, electrical/sensing, software etc.) and should
be able to explain their role during technical judging. Non-technical
roles, such as documentation, poster or graphic design, or presentation,
may be shared by team members but do not on their own count as a
technical role.

=== Team Qualification Process
* Teams may only qualify for SuperRegional and International competitions
through their region's Regional Representative. Teams may not qualify or
register for these competitions directly.
* Each SuperRegional competition allocates slots to its participating regions,
and the Regional Representative assigns those slots to qualified teams from
their region.
* Qualified teams must meet the <<team-continuity,Team Continuity>> requirement.
...
==== Open and Invitational Events
* Some regional competitions (Regional Opens) and SuperRegional competitions
(SuperRegional Invitationals) include Open or Invitational events that teams
may enter without qualifying through their region.
* Teams wishing to attend an Open or Invitational event outside their region
should contact their Regional Representative, who can support the team's
application to the event organizers.
* Taking part in an Open or Invitational event does not by itself qualify a
team for a SuperRegional or International competition.
